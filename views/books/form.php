...
<form action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <select class="form-select" aria-label="multiple select example" name="author">
            ...
            <option value="<?php echo $author['id']; ?>"<?php if ($book_authors === $author['id']) echo "selected" ?> ><?php echo $author['a_name'] . ' ' . $author['lastName']?></option>
      <?php }?>
        </select>
    </div>
    <div class="mb-3">
        ...
        <select class="form-select" aria-label="Default select example" name="edit">
            <option disabled selected value> -- select an option -- </option>
            <?php foreach ($editorial as $key => $edit) {?>
            <option value="<?php echo $edit['id']; ?>" <?php if ($book_edit === $edit['id']) echo "selected" ?> ><?php echo $edit['e_name'] . '-' . $edit['e_country']?></option>
            <?php }?>
        </select>
    </div>
    <div class="mb-3">
